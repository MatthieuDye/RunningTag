...
<html>
  ...
  <head> <link href="http://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet">
   ...
   <div class="row z-depth-4 blue-grey lighten-5">
          ...
          <div class="row">
            <div class="input-field col s12">
             <textarea rows="10" cols="50" name="description" id="description" class="materialize-textarea"></textarea>
              <label for="description">Ici vous pouvez rédiger une petite description de votre évènement</label>
            </div>
          </div>
